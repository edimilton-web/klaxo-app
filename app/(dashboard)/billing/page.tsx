...
export default function BillingPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/settings").then(r => r.json()).then(d => setPlan(d?.plan ?? "FREE"))
  }, [params])
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {plan === null ? (
        <div className="rounded-2xl border border-white/[0.12] bg-[#16161F] px-5 py-10 flex items-center justify-center">
