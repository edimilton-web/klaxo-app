    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0F] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/[0.10] bg-[#16161F] p-6">
          {sent ? (
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-white/40">We sent a reset link to <strong className="text-white/70">{email}</strong></p>
              <Link href="/login">
        ...
        <p className="mt-4 text-center text-sm text-white/40">
          <Link href="/login" className="font-medium text-violet-400 hover:text-violet-300">← Back to sign in</Link>
        </p>
      </div>
    </div>
  )
